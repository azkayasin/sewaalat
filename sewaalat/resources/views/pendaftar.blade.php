					...
					<table>
						<thead>
							<tr class="table100-head">
								<th class="column1">Nama Pendaftar</th>
						...
						<tbody>
								@foreach ($pendaftar as $orang)
								<tr>
									<td class="column1">{{$orang->name}}</td>
									<td class="column3">{{$orang->email}}</td>
									<td class="column3">{{$orang->phone}}</td>
									<td class="column2">{{$orang->alamat}}</td>
								</tr>
								@endforeach
						</tbody>
					</table>
